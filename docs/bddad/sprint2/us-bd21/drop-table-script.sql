...
DROP TABLE InstrumentoAgricola CASCADE CONSTRAINTS;
DROP TABLE InstrumentoUtilizado CASCADE CONSTRAINTS;
DROP TABLE Maquina CASCADE CONSTRAINTS;
DROP TABLE MaquinaUtilizada CASCADE CONSTRAINTS;
...
DROP TABLE TipoMaquina CASCADE CONSTRAINTS;
