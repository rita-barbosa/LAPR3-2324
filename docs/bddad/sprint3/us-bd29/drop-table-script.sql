...
DROP TABLE CatalogoReceitaFertirrega CASCADE CONSTRAINTS;
...
DROP TABLE CulturaInstaladaEstadoFenologico CASCADE CONSTRAINTS;
...
DROP TABLE PlantaPermanencia CASCADE CONSTRAINTS;
DROP TABLE Producao CASCADE CONSTRAINTS;
DROP TABLE Produto CASCADE CONSTRAINTS;
DROP TABLE ProdutoColhido CASCADE CONSTRAINTS;
DROP TABLE ReceitaFertirrega CASCADE CONSTRAINTS;
